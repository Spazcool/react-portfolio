...
export default function About(props){
  return (
    <Card
      name='Douglas Wright'
      imagePath='http://spazcool-react-portfolio.s3-website-us-east-1.amazonaws.com/images/face.jpg'
      ...
      <p>Please have a look at my <Link key='personal' to='http://spazcool-react-portfolio.s3-website-us-east-1.amazonaws.com/projects/personal'>personal</Link> or <Link key='freelance' to='http://spazcool-react-portfolio.s3-website-us-east-1.amazonaws.com/projects/freelance'>freelance</Link> projects, each one includes a link to both its deployed site as well as its own repo on GitHub, should you want to peek at the code. Feel free to contact me if you like what you see.</p>
